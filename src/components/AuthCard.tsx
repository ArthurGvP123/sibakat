      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 pt-16 pb-10">
        ...
        <div className="mb-10">
          <div className="inline-flex items-center gap-2 animate-float">
            ...
            <div className="text-2xl font-bold tracking-tight">SiBakat<span className="text-primary">.id</span></div>
          </div>
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-start">
          ...
          <div className="hidden lg:block">
            ...
            <p className="mt-4 text-slate-600">
              SiBakat.id membantu menganalisis 6 indikator fisik siswa dan merekomendasikan cabang olahraga yang paling cocok.
            </p>
