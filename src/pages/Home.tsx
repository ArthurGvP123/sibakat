  ...
  return (
    <AppLayout>
      ...
      <div className="mb-12 animate-fadeIn animation-delay-200">
        ...
        {/* Grid 6 Cards: Responsif */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          
          {/* 1. Panduan Tes (WARNA: ORANYE) */}
          <Link 
          ...
          {/* 2. Petunjuk Aplikasi (WARNA: HIJAU) */}
          <Link 
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-slate-600 text-sm mb-4 leading-relaxed">
                Buka <b>Data Anak</b> dan klik <b>View</b>. Sistem otomatis menghitung potensi dan rekomendasi.
              </p>
          ...
          {/* 6. Ekspor Laporan (WARNA: KUNING/AMBER) */}
          <Link 
            to="/data-anak"
      ...
      {/* --- SECTION PROFIL PENELITI (Light Theme & Card Style) --- */}
      <div className="mt-16 mb-10 animate-fadeIn animation-delay-300">
        <Link
          to="/profil-peneliti"
          className="
            card p-8 flex flex-col md:flex-row items-center gap-6 
            relative overflow-hidden group hover:shadow-lg transition-all 
            border border-slate-200 border-l-[6px] border-l-slate-600 
        ...
        >
          ...
          <div className="flex-1 text-center md:text-left z-10">
            <h2 className="text-lg sm:text-xl font-bold text-slate-800 mb-2 group-hover:text-slate-700 transition-colors">
              Kenali Tim Peneliti & Pengembang
            </h2>
            <p className="text-slate-600 text-sm leading-relaxed max-w-3xl mx-auto md:mx-0">
              Aplikasi ini dikembangkan berdasarkan riset akademik Universitas Negeri Semarang (UNNES) untuk mendukung kemajuan <i>Sport Science</i> di Indonesia.
            </p>
          </div>
